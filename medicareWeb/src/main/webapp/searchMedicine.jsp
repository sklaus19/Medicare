		...
		<div class="container">
			<p class="display-6"><strong>Search for Medicines</strong></p><br/>
				...
				<%
					...
					String responseString = "<table class='display' id='medicineTable' style='width:100%;color:black;'>";
					responseString += "<thead style='color:white;'><tr><th>Name</th><th>Description</th><th>Seller</th>";
					...
					for(Map.Entry<Integer,Medicine> entry : medicineMap.entrySet()) {
						...
						if(medicine.isActive()==true) {
							...
							responseString += "<td><input class='btn btn-outline-warning' type='submit' value='Add' onclick='addToCart("+medicineId+")' /></td>";
							responseString += "<td><input class='btn btn-outline-warning' type='submit' value='Remove' onclick='removefromCart("+medicineId+")' /></td>";
